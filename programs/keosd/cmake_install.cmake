# Install script for directory: /root/telos/programs/keosd
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  if(EXISTS "$ENV{DESTDIR}/usr/local/eosio/bin/keosd" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/eosio/bin/keosd"
         RPATH "")
  endif()
...
file(INSTALL DESTINATION "/usr/local/eosio/bin" TYPE EXECUTABLE FILES "/root/telos/build/programs/keosd/keosd")
  if(EXISTS "$ENV{DESTDIR}/usr/local/eosio/bin/keosd" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/eosio/bin/keosd")
