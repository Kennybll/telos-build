...
contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.o: ../contracts/eosio.sudo/eosio.sudo.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.o"
	cd /root/telos/build/contracts/eosio.sudo && /usr/bin/clang++-4.0   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.o -c /root/telos/contracts/eosio.sudo/eosio.sudo.cpp
...
contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.i: cmake_force
	...
	cd /root/telos/build/contracts/eosio.sudo && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/telos/contracts/eosio.sudo/eosio.sudo.cpp > CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.i
...
contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.s: cmake_force
	...
	cd /root/telos/build/contracts/eosio.sudo && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/telos/contracts/eosio.sudo/eosio.sudo.cpp -o CMakeFiles/eosio.sudo.tmp.dir/eosio.sudo.cpp.s
...
contracts/eosio.sudo/eosio.sudo.tmp: contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable eosio.sudo.tmp"
	cd /root/telos/build/contracts/eosio.sudo && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/eosio.sudo.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/clean:
	cd /root/telos/build/contracts/eosio.sudo && $(CMAKE_COMMAND) -P CMakeFiles/eosio.sudo.tmp.dir/cmake_clean.cmake
.PHONY : contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/clean

contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/depend:
	cd /root/telos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/telos /root/telos/contracts/eosio.sudo /root/telos/build /root/telos/build/contracts/eosio.sudo /root/telos/build/contracts/eosio.sudo/CMakeFiles/eosio.sudo.tmp.dir/DependInfo.cmake --color=$(COLOR)
