...
{
   "TELOS-NOTE": "THIS WAS NOT GENERATED WITH EOSIOCPP",
   ...
   "structs": [{
     "name": "schedule_metrics",
      ...
      "fields": [
        ...
        {"name":"block_counter_correction", "type":"int32"},
        {"name":"producers_metric",         "type":"producer_metric[]"}
      ]
   },{
     "name": "producer_metric",
      ...
      "fields": [
        ...
        {"name":"missed_blocks_per_cycle", "type":"uint32"}
      ]
   },{
      "name": "rotation_info",
      "base": "",
      ...
      "fields": [
        {"name":"bp", "type":"account_name"},
        {"name":"penalty_hours", "type":"uint32"}
      ]
    },{
      "name": "wait_weight",
      "base": "",
      ...
      "fields": [
         ...
         {"name":"last_proposed_schedule_update", "type":"block_timestamp_type"},
      ...
      "fields": [
         ...
         {"name":"lifetime_unpaid_blocks",      "type":"uint32"},
         {"name":"missed_blocks_per_rotation",  "type":"uint32"},
         {"name":"lifetime_missed_blocks",      "type":"uint32"},
         {"name":"last_claim_time",             "type":"uint64"},
         {"name":"location",                    "type":"uint16"},
         {"name":"kick_reason_id",              "type":"uint32"},
         {"name":"kick_reason",                 "type":"string"},
         {"name":"times_kicked",                "type":"uint32"},
         {"name":"kick_penalty_hours",          "type":"uint32"},
         {"name":"last_time_kicked",            "type":"block_timestamp_type"}
      ]
    },{
      "name": "regproducer",
      "base": "",
   ...
   "tables": [{
      "name": "schedulemetr",
      "type": "schedule_metrics",
      "index_type": "i64",
      "key_names" : ["last_onblock_caller"],
      "key_types" : ["uint64"]
    },{
      "name": "rotations",
      "type": "rotation_info",
