...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o: ../contracts/simple.token/simple.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o"
	cd /root/telos/build/contracts/simple.token && /usr/bin/clang++-4.0   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.o -c /root/telos/contracts/simple.token/simple.token.cpp
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i: cmake_force
	...
	cd /root/telos/build/contracts/simple.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/telos/contracts/simple.token/simple.token.cpp > CMakeFiles/simple.token.tmp.dir/simple.token.cpp.i
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s: cmake_force
	...
	cd /root/telos/build/contracts/simple.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/telos/contracts/simple.token/simple.token.cpp -o CMakeFiles/simple.token.tmp.dir/simple.token.cpp.s
...
contracts/simple.token/simple.token.tmp: contracts/simple.token/CMakeFiles/simple.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable simple.token.tmp"
	cd /root/telos/build/contracts/simple.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/simple.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/clean:
	cd /root/telos/build/contracts/simple.token && $(CMAKE_COMMAND) -P CMakeFiles/simple.token.tmp.dir/cmake_clean.cmake
...
contracts/simple.token/CMakeFiles/simple.token.tmp.dir/depend:
	cd /root/telos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/telos /root/telos/contracts/simple.token /root/telos/build /root/telos/build/contracts/simple.token /root/telos/build/contracts/simple.token/CMakeFiles/simple.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
