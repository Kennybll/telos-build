...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o: ../contracts/eosio.token/eosio.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o"
	cd /root/telos/build/contracts/eosio.token && /usr/bin/clang++-4.0   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o -c /root/telos/contracts/eosio.token/eosio.token.cpp
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i: cmake_force
	...
	cd /root/telos/build/contracts/eosio.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/telos/contracts/eosio.token/eosio.token.cpp > CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s: cmake_force
	...
	cd /root/telos/build/contracts/eosio.token && /usr/bin/clang++-4.0  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/telos/contracts/eosio.token/eosio.token.cpp -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s
...
contracts/eosio.token/eosio.token.tmp: contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/telos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable eosio.token.tmp"
	cd /root/telos/build/contracts/eosio.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/eosio.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/clean:
	cd /root/telos/build/contracts/eosio.token && $(CMAKE_COMMAND) -P CMakeFiles/eosio.token.tmp.dir/cmake_clean.cmake
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/depend:
	cd /root/telos/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/telos /root/telos/contracts/eosio.token /root/telos/build /root/telos/build/contracts/eosio.token /root/telos/build/contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/DependInfo.cmake --color=$(COLOR)
